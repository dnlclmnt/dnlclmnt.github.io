(function() {
	...
	// "On Visible" animations.
		onvisible.add('#container07', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: true });
		onvisible.add('#container05', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: true });
		onvisible.add('#container06', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: true });
		onvisible.add('#buttons03', { style: 'blur-in', speed: 1000, intensity: 5, delay: 0, replay: false });
